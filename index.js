...
console.log(copy(`Task 1: ${copy(originalFlavors)}`));
...
function getFlavorByIndex(arr, num) {
  return arr.splice(num, 1).toString();
}
...
function removeFlavorByName(arr, newFlavor) {
  /*your code here*/
  let num = arr.indexOf(newFlavor);
  arr.splice(num, 1);
  return arr;
}

console.log("Task 4", removeFlavorByName(originalFlavors, "Rocky Road"));
